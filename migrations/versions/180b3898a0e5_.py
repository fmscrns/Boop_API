...
Revision ID: 180b3898a0e5
Revises: 
Create Date: 2020-01-14 22:49:27.892530
...
def upgrade():
    ...
    sa.Column('for_adoption', sa.Boolean(), nullable=False),
    ...
    sa.Column('commented_on', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['commented_on'], ['post.post_id'], ),
