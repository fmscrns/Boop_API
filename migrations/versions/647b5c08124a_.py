...
Revision ID: 647b5c08124a
Revises: 
Create Date: 2020-01-19 15:58:48.039719
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['uploader'], ['user.username'], ondelete='cascade'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('public_id')
    )
    ...
    sa.ForeignKeyConstraint(['photo_id'], ['photo.public_id'], ondelete='cascade'),
    ...
    op.create_table('post_photo_rel',
    sa.Column('public_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('post_id', sa.String(), nullable=True),
    sa.Column('photo_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['photo_id'], ['photo.public_id'], ondelete='cascade'),
